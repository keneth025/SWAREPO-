...
var restDelete_1 = require("./routers/restDelete");
        ...
        (function () { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ctx = _a.sent();
                        context = __assign(__assign({}, ctx), { proxyHostUrl: "".concat(this.settings.protocol, "://").concat(this.settings.hostname, ":").concat(this.settings.port) });
                        ...
                        this.routers.apiRestRouter.post("/*(".concat([
                            '/attachmentfiles/add',
                            '/files/add',
                            '/startUpload',
                            '/continueUpload',
                        ...
                        this.routers.apiRestRouter.delete('/*', new restDelete_1.RestDeleteRouter(context, this.settings).router);
                        (function () {
                        ...
                        upCallback = function (s, cx, settings, cb) {
                            _this.logger.info("SharePoint REST Proxy has been started on ".concat(cx.proxyHostUrl));
