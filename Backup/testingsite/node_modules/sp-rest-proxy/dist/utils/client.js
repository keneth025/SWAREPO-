                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 5:
                            ...
                            return [3, 6];
                        case 6:
                            opts = __assign(__assign(__assign({ agent: this.agent }, init), auth.options || {}), { headers: (0, headers_1.mergeHeaders)(init === null || init === void 0 ? void 0 : init.headers, new node_fetch_1.Headers(auth.headers), new node_fetch_1.Headers(digest ? { 'X-RequestDigest': digest } : {})) });
                            return [2, (0, node_fetch_1.default)(url, opts)];
                    }
                });
            });
        };
        this.requestDigest = function (webUrl) {
            var d = cache_1.cache.get("".concat(webUrl, ":digest"));
            if (d) {
                return Promise.resolve(d);
            }
            return _this.fetch("".concat(webUrl, "/_api/contextinfo"), {
                method: 'POST',
                ...
                cache_1.cache.set("".concat(webUrl, ":digest"), digest, ttl - 30 * 1000);
                return digest;
            });
        };
