    ...
    function Client(settings, proxy) {
        ...
        this.init = function () {
            _this.socket.on('REQUEST', function (request) {
                ...
                _this.logger.info("".concat(request.method, " request to ").concat(endpoint));
                var responsePackage = {
        ...
        this.enpointUrl = function (relativeUrl) {
            ...
            return "http://".concat(hostname, ":").concat(port).concat(relativeUrl)
                .replace(':80/', '/').replace(':443/', '/');
        };
        this.socket = (0, socket_io_client_1.default)(settings.serverUrl);
